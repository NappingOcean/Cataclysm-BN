...
---@class MonGroup
---@field get_monsters_from_group fun(arg1: MonGroup): any
---@field get_random_monster_from_group fun(arg1: MonGroup): MtypeId
---@field is_animal fun(arg1: MonGroup): boolean
---@field is_monster_in_group fun(arg1: MonGroup, arg2: MtypeId): boolean
---@field is_valid_monster_group fun(arg1: MonGroup): boolean
MonGroup = {}
---@return MonGroup
function MonGroup.new() end
...
---@field get_monstergroup_overmap_at fun(arg1: Tripoint): any
